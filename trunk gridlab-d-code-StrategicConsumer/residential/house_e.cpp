...
void house_e::update_system(double dt)
{
	...
	//printf("heating_cop=%f, cooling_cop=%f, designHeatingCap=%f, designCoolingCap=%f\n", heating_COP, cooling_COP, design_heating_capacity ,design_cooling_capacity);
