...
class jacuzzi : public residential_enduse {
private:
...
public:
	...
	double is_jacuzzi_on;		///< Simple logic for determining state of jacuzzi 1-on, 0-off
public:
	...
	double gas_fan_power;		///< fan power draw when a gas jacuzzi is burning fuel
	double gas_standby_power;	///< standby power draw when a gas jacuzzi is NOT burning fuel

	double actual_load;
	double prev_load;
	complex jacuzzi_actual_power;	///< the actual power draw of the object after accounting for voltage


public:
	static CLASS *oclass, *pclass;
	static jacuzzi *defaults;
